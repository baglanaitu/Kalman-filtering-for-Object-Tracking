...
int main(int argc, char ** argv)
{
	...
	double t, acum_t; //variables for execution time
		...
		string baseline_seq[4]= {"lab3.3/abandonedBox_600_1000_clip", "lab3.3/boats_6950_7900_clip", "lab3.3/pedestrians_800_1025_clip", "lab3.3/streetCornerAtNight_0_100_clip"};
